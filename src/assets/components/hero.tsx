...
export function Hero() {
  return (
    <div className="">
      <div className="mt-7">
          <h1 className="text-7xl rubik-dirt" style={{ mixBlendMode: "difference",maxWidth:'400px' }}>
            קווים לדמותם
          </h1>
          <p className="font-light text-lg text-justify" style={{ mixBlendMode: "difference",maxWidth:'400px' }}>{heroText}</p>
      </div>
      <div className="absolute" style={{ zIndex: "-1", left:'10rem',bottom:'-80px' }}>
        <Candle isLit={true} />
      </div>
    </div>
  );
