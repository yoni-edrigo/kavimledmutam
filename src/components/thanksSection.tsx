...
export function ThanksSection({ volunteerArr }: { volunteerArr: Volunteer[] }) {
  return (
    ...
    >
      <div className=" inner-content flex flex-column align-items-center">
        <h2
        ...
        <div
          className="volunteer-grid gap-3 md:gap-7 justify-content-between align-items-start"
              ...
              .map((volunteer, index) => (
                <AnimatedGridOnScroll key={index} index={index}>
                  ...
                  >
                    ...
                    <h3 className="text-center">{volunteer.name}</h3>
                    {volunteer.link ? (
                      <a
                        href={volunteer.link}
                        style={{
